...
class _BatchMeta implements Message {
  ...
  constructor(public pageNo: number, public firstIndex: number, public timestamp: number) {}
...
class _SetPageLocation implements Message {
  ...
  constructor(public url: string, public referrer: string, public navigationStart: number) {}
  encode(writer: Writer): boolean {
    return (
      writer.uint(4) &&
...
class _CreateTextNode implements Message {
  ...
  constructor(public id: number, public parentID: number, public index: number) {}
  encode(writer: Writer): boolean {
    return (
      writer.uint(9) &&
      writer.uint(this.id) &&
...
class _SetInputValue implements Message {
  ...
  constructor(public id: number, public value: string, public mask: number) {}
  encode(writer: Writer): boolean {
    return (
      writer.uint(18) && writer.uint(this.id) && writer.string(this.value) && writer.int(this.mask)
    )
  }
}
...
class _SetInputChecked implements Message {
  ...
  constructor(public id: number, public checked: boolean) {}
  encode(writer: Writer): boolean {
...
class _ConsoleLog implements Message {
  ...
  constructor(public level: string, public value: string) {}
  encode(writer: Writer): boolean {
...
class _JSException implements Message {
  ...
  constructor(public name: string, public message: string, public payload: string) {}
  encode(writer: Writer): boolean {
    return (
      writer.uint(25) &&
      writer.string(this.name) &&
...
class _CSSInsertRule implements Message {
  ...
  constructor(public id: number, public rule: string, public index: number) {}
  encode(writer: Writer): boolean {
    return (
      writer.uint(37) && writer.uint(this.id) && writer.string(this.rule) && writer.uint(this.index)
    )
  }
}
...
class _Redux implements Message {
  ...
  constructor(public action: string, public state: string, public duration: number) {}
  encode(writer: Writer): boolean {
    return (
      writer.uint(44) &&
...
class _Vuex implements Message {
  ...
  constructor(public mutation: string, public state: string) {}
  encode(writer: Writer): boolean {
...
class _ConnectionInformation implements Message {
  ...
  constructor(public downlink: number, public type: string) {}
  encode(writer: Writer): boolean {
...
class _SetCSSDataURLBased implements Message {
  ...
  constructor(public id: number, public data: string, public baseURL: string) {}
  encode(writer: Writer): boolean {
    return (
      writer.uint(61) &&
      writer.uint(this.id) &&
...
class _CreateIFrameDocument implements Message {
  ...
  constructor(public frameID: number, public id: number) {}
  encode(writer: Writer): boolean {
